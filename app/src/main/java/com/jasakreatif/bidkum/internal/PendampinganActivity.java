...
//public class PendampinganActivity extends AppCompatActivity {
//
//    @Override
...
import com.jasakreatif.bidkum.pendampingan.adapter.Adapter;
import com.jasakreatif.bidkum.pendampingan.app.AppController;
import com.jasakreatif.bidkum.pendampingan.data.Data;
import com.jasakreatif.bidkum.pendampingan.util.Server;
...
public class PendampinganActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private static final String TAG = PendampinganActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Adapter(PendampinganActivity.this, itemList);
        ...
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(final AdapterView<?> parent, View view,
                ...
                dialog = new AlertDialog.Builder(PendampinganActivity.this);
    ...
    private void DialogForm(String idx, String namax, String alamatx, String button) {
        ...
        dialogView = inflater.inflate(R.layout.form_pendampingan, null);
        dialog.setView(dialogView);
        dialog.setCancelable(true);
        dialog.setIcon(R.mipmap.ic_launcher);
        dialog.setTitle("Form Pendampingan");
    ...
    private void simpan_update() {
        ...
        StringRequest strReq = new StringRequest( Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Toast.makeText(PendampinganActivity.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG).show();
                        adapter.notifyDataSetChanged();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(PendampinganActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        }) {
