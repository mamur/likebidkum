...
import com.jasakreatif.bidkum.adapter.CustomAdapter;
...
public class ChatFragment extends Fragment {
    ...
    int [] thumbnail = {R.drawable.hadiana, R.drawable.hadiana,R.drawable.hadiana};
    String [] judul = {"Cikondang United","Cikondang United","Cikondang United"};
    String [] deskripsi = {"National of Freedom for Palestine","National of Freedom for Palestine","National of Freedom for Palestine"};
