...
import com.jasakreatif.bidkum.Tab.MyExternalAdapter;
...
public class MainExternalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_external);
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        mViewPager.setAdapter(new MyExternalAdapter(getSupportFragmentManager(), this));
